...
function App() {
   ...
   return (
      <div className='h-screen relative overflow-hidden w-full flex justify-center items-center bg-gray-50'>
         <div className='h-[90%] overflow-auto z-0 w-[90%] bg-white rounded-2xl'>
               ...
               modal ?
                  <>
                     <div className='absolute top-0 left-0 h-full w-full'>
                        <div style={{ transform: "translateX(-50%) translateY(-50%)" }} className='absolute flex justify-center rounded-2xl z-20 items-center top-1/2 left-1/2 bg-white w-140 not-sm:w-90 opacity-100'>
